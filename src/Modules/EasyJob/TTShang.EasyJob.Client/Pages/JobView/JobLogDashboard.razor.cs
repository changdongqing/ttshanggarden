...
namespace TTShang.EasyJob.Client.Pages.JobView
{
    public partial class JobLogDashboard : ReuseTabsPageBase, IDisposable
    {
        ...
        /// 通知订阅者
        /// </summary>
        private ISubscriber? logNotificationSubscriber;
        ...
        protected override void OnInitialized()
        {
            ...
            var _timeQueryCodes = DictHelper.GetCodesFromCache("easy_job_count_query_date");
            timeQueryDays = _timeQueryCodes?.FirstOrDefault()?.CodeValue;
            timeQueryCodes = _timeQueryCodes;
            base.OnInitialized();
        }
        ...
        private async Task OnTimeQueryTypeSelectedItemChanged(string value)
        {
            Task[] tasks = new Task[]
             {
                ReLoadAllCount(),
