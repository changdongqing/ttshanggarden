...
namespace Gardener.EasyJob.Client.Services
{
    ...
    public class SysJobLogService : ClientServiceBase<SysJobLogDto, long>, ISysJobLogService
    {
        ...
        /// 定时任务-运行日志
        /// </summary>
        public SysJobLogService(IApiCaller apiCaller) : base(apiCaller, "sys-job-log", "job")
        {
        }
        ...
        public Task<IEnumerable<SysJobLogElapsedTime>> GetAvgElapsedTime(string? jobId = null, int? days = null)
        {
            ...
            return apiCaller.GetAsync<IEnumerable<SysJobLogElapsedTime>>($"{this.baseUrl}/avg-elapsed-time", queryString);
        }
        ...
        public Task<SysJobLogAllCount> GetAllCount(string? jobId = null, int? days = null)
        {
            ...
            return apiCaller.GetAsync<SysJobLogAllCount>($"{this.baseUrl}/all-count", queryString);
        }
        ...
        public Task<IEnumerable<SysJobLogCount>> GetCount(string? jobId = null, int? days = null)
        {
            ...
            return apiCaller.GetAsync<IEnumerable<SysJobLogCount>>($"{this.baseUrl}/count", queryString);
        }
    }
}
