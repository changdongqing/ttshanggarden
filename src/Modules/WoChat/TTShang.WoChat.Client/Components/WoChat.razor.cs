...
using TTShang.WoChat.Dtos;
using TTShang.WoChat.Dtos.Notification;
using TTShang.WoChat.Enums;
using TTShang.WoChat.Services;
using Microsoft.AspNetCore.Components;
using Microsoft.Extensions.Options;

namespace TTShang.WoChat.Client.Components
{
    /// <summary>
    /// wo chat 聊天
    /// </summary>
    public partial class WoChat : OperationDialogBase<WoChatDialogConfig, bool, WoChatResource>
    {
        ...
        /// 消息列表区高度
        /// </summary>
        private string messageListHeight = "350px";
        /// <summary>
        /// 头像显示形状
        /// </summary>
        ...
        /// 订阅者
        /// </summary>
        private ISubscriber? messageNotificationSubscriber;
        /// <summary>
        /// 用户列表选中的用户
        /// </summary>
        ...
        /// 发送消息按钮加载中状态
        /// </summary>
        private bool sendMessageBtnLoading = false;
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            //消息区域高度
            messageListHeight =$"calc({Height} - {MessageInputHeight + MessageTitleHeight}px)";

            //当前用户
            currentUser = authenticationStateManager.GetCurrentUser();
            //默认到消息列表
        ...
        private async Task OnShowImageList(bool visible)
        {
            ...
            if (await authenticationStateManager.TestToken("WoChat"))
            {
                ...
                //
                IEnumerable<SystemAttachmentDto> attachmentDtos = await task;
