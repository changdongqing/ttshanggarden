    ...
    public class MyRESTfulResultProvider : IUnifyResultProvider
    {
        ...
        public IActionResult OnException(ExceptionContext context, ExceptionMetadata metadata)
        {
            ...
            if (context.Exception is DbUpdateException)
            {
                ...
                {
                    return new JsonResult(RESTfulResult(500, errorCode: nameof(TTShang.Core.Resources.SharedLocalResource.FOREIGN_KEY_CONSTRAINT_FAILS), errors: TTShang.Core.Resources.SharedLocalResource.FOREIGN_KEY_CONSTRAINT_FAILS), _jsonOptions.Value.JsonSerializerOptions);
                }
            }
