...
namespace Gardener.Core.Impl.Localization
{
    /// <summary>
    /// 本地化器
    /// </summary>
    /// <typeparam name="T"></typeparam>
    internal class LocalizationLocalizerImpl<T> : ILocalizationLocalizer<T>
    {
    ...
    /// 先从指定的资源查找，找不到再从公共资源查找
    /// </remarks>
    internal class LocalizationLocalizerCompensationImpl<T> : LocalizationLocalizerImpl<T>, ILocalizationLocalizer<T>
    {
        ...
        public override LocalizedString Get(string name)
        {
            ...
            if (localizedString.ResourceNotFound && !commonLocalizer.GetResourceFullName().Equals(GetResourceFullName()))
            {
