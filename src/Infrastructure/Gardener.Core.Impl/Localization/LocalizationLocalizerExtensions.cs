...
namespace Gardener.Core.Impl.Localization
{
    ...
    public static partial class LocalizationLocalizerExtensions
    {
        ...
        /// </remarks>
        public static IServiceCollection AddLocalization<TDefaultResource>(this IServiceCollection services)
        {
            services.AddSingleton<IServerModule, LocalizationServerModule>();
