...
namespace Gardener.Core.Client.Impl.UserCenter.Pages.UserView
{
    public partial class UserRoleEdit: OperationDialogBase<UserDto, bool, UserCenterResource>
    {
        ...
        private CheckboxOption<string>[] _roleOptions = new CheckboxOption<string>[] { };
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (_userId > 0)
            {
                ...
                _roleOptions = rolesResult.OrderBy(x=>x.CreatedTime).Select(x => new CheckboxOption<string>
                {
                    Label = x.Name,
                    Value = x.Id.ToString(),
