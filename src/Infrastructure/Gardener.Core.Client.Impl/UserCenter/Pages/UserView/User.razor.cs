...
using Gardener.Core.Client.Impl.UserCenter.Pages.AccountView.LoginClientView;
using Microsoft.AspNetCore.Components.Web;

namespace Gardener.Core.Client.Impl.UserCenter.Pages.UserView
{
    public partial class User : ListOperateTableBase<UserDto, int, UserEdit, UserCenterResource>
    {
        ...
        /// </summary>
        /// <param name="user"></param>
        private Task OnShowConnectionsClick(UserDto user)
        {
            return OpenOperationDialogAsync<OnlineConnection, int?, bool>(Localizer[nameof(SharedLocalResource.Connection)], user.Id, width: "80%");
        }
        /// <summary>
        /// 点击头像
        /// </summary>
