...
namespace Gardener.Core.Client.Tag
{
    /// <summary>
    /// tag 加强
    /// </summary>
    ...
    public partial class TagPro : AntDomComponentBase
    {
        ...
        protected override void OnParametersSet()
        {
            ...
            if (string.IsNullOrEmpty(Color))
            {
                ...
                {
                    tempColor = PresetColor.Value.ToString();
                }
            }
            else
            {
            ...
            if (ChildContent == null || string.IsNullOrEmpty(tempColor))
            {
                if (Text.GetType().IsEnum)
                {
                    value = EnumHelper.GetEnumDescriptionOrName((Enum)Text);
                }
                else
                {
                    value = Text.ToString();
        ...
        private void InitEnumTagIcon()
        {
            ...
            TagIconAttribute? attr = EnumHelper.GetEnumAttribute<TagIconAttribute>((Enum)Text);
            if (attr == null)
            {
                return;
            }
            _icon = Icon ?? attr.Icon;
            _iconTheme = IconTheme ?? attr.Theme;
            _iconSpin = IconSpin ?? attr.Spin;
        ...
        {
            TagColorAttribute? tagColorAttribute = EnumHelper.GetEnumAttribute<TagColorAttribute>(value);
