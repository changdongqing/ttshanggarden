...
namespace Gardener.Core.Client.Extensions
{
    /// <summary>
    /// 确认提示框服务扩展
    /// </summary>
    public static class ConfirmServiceExtension
    {
        ...
        /// <returns></returns>
        public async static Task<ConfirmResult> YesNo(this IConfirmService confirmService, string title, string content, ConfirmIcon confirmIcon, string btn1Text = nameof(SharedLocalResource.Yes), string btn2Text = nameof(SharedLocalResource.Cancel), string btn3Text = "")
        {
        ...
        /// </remarks>
        public async static Task<ConfirmResult> YesNo(this IConfirmService confirmService, string title, string content)
        {
        ...
        /// <para>confirmIcon此时为 <see cref="ConfirmIcon.Question"/></para>
        /// </remarks>
        public async static Task<ConfirmResult> YesNo(this IConfirmService confirmService, string title)
        {
        ...
        /// <para>confirmIcon此时为 <see cref="ConfirmIcon.Question"/></para>
        /// </remarks>
        public async static Task<ConfirmResult> YesNoDelete(this IConfirmService confirmService)
        {
