...
namespace Gardener.Core.Util
{
    ...
    public static class DictHelper
    {
        ...
        /// <param name="fieldExpression">获取字段表达式</param>
        /// <returns></returns>
        public static IEnumerable<CodeDto>? GetCodesFromCache<TDto>(Expression<Func<TDto, object?>> fieldExpression)
        {
            var codeTypeValue = GetCodeType<TDto>(fieldExpression);
            if (codeTypeValue == null)
            {
                return null;
            }
        ...
        /// <param name="fieldExpression">获取字段表达式</param>
        /// <returns></returns>
        public static string? GetCodeType<TDto>(Expression<Func<TDto, object?>> fieldExpression)
        {
