...
namespace Gardener.Core.Common.Entities
{
    ...
    /// </summary>
    /// <remarks>
    /// 多租户无主键基类,包含预置字段<see cref="TenantEntityBaseInfoNoKey"/>
    /// </remarks>
    [SuppressSniffer]
    ...
    /// <typeparam name="TKey">主键类型</typeparam>
    /// <remarks>
    /// 单主键<typeparamref name="TKey"/>基类,包含预置字段<see cref="EntityBaseInfoNoKey"/>
    /// </remarks>
    [SuppressSniffer]
    ...
    /// <typeparam name="TKey">主键类型</typeparam>
    /// <remarks>
    /// 单主键<typeparamref name="TKey"/>基类，无预置字段
    /// </remarks>
    [SuppressSniffer]
    ...
    /// <typeparam name="TKey">主键类型</typeparam>
    /// <remarks>
    /// 多租户单主键<typeparamref name="TKey"/>基类，包含预置字段<see cref="TenantEntityBaseInfoNoKey"/>
    /// </remarks>
    [SuppressSniffer]
    ...
    /// <typeparam name="TDbContextLocator1"></typeparam>
    /// <remarks>
    /// 多租户单主键<typeparamref name="TKey"/>基类，不包含预置字段
    /// </remarks>
    [SuppressSniffer]
