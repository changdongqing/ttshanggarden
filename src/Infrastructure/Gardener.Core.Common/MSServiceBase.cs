...
namespace Gardener.Core.Common
{
        ...
        where TSlaveDbContextLocator : class, IDbContextLocator
    {
        ...
        public MSServiceBase(IMSRepository<TDbContextLocator, TSlaveDbContextLocator> repository) : base(repository.Master<TEntity>())
        {
        ...
        /// </summary>
        /// <returns></returns>
        public override IPrivateReadableRepository<TEntity> GetReadableRepository()
        {
        ...
        where TSlaveDbContextLocator : class, IDbContextLocator
    {
        ...
        /// </summary>
        /// <param name="repository"></param>
        public MSServiceBase(IMSRepository<MasterDbContextLocator, TSlaveDbContextLocator> repository) : base(repository)
        {
        }
    }
