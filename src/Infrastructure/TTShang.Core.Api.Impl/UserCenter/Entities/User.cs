        ...
        public IEnumerable<User> HasData(DbContext dbContext, Type dbContextLocator)
        {
            ...
            return new[]
            {
                new User
                {
                    ...
                    Password=MD5Helper.Encrypt("admin"+passwordEncryptKey),
                ...
                new User
                {
                    ...
                    NickName="测试员",
                    PasswordEncryptKey=passwordEncryptKey,
                    Password=MD5Helper.Encrypt("testuser"+passwordEncryptKey),
                ...
                new User
                {
                    ...
                    NickName="东方财富播报",
                    PasswordEncryptKey=passwordEncryptKey,
                    Password=MD5Helper.Encrypt("dongfangcaifu"+passwordEncryptKey),
                ...
                new User
                {
                    ...
                    NickName="租户1用户1",
                    PasswordEncryptKey=passwordEncryptKey,
                    Password=MD5Helper.Encrypt("zuhu1_user1"+passwordEncryptKey),
                ...
                new User
                {
                    ...
                    NickName="租户2用户1",
                    PasswordEncryptKey=passwordEncryptKey,
                    Password=MD5Helper.Encrypt("zuhu2_user1"+passwordEncryptKey),
                ...
                new User
                {
                    ...
                    NickName="租户2用户2",
                    PasswordEncryptKey=passwordEncryptKey,
                    Password=MD5Helper.Encrypt("zuhu2_user2"+passwordEncryptKey),
                ...
                {
                    Id=13,
                    UserName="db_z1_admin",
                    NickName="租户1管理员2",
                    PasswordEncryptKey=passwordEncryptKey,
                    Password=MD5Helper.Encrypt("db_z1_admin"+passwordEncryptKey),
                    Avatar=null,
                    CreatedTime=DateTimeOffset.FromUnixTimeSeconds(1628689311),
                    DeptId=null,
                    PositionId=null,
