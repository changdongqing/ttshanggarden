...
using TTShang.Core.Api.Impl.LicensePlateRecognition.Internal;
using TTShang.Core.Api.Impl.LicensePlateRecognition.Services;
using TTShang.Core.LicensePlateRecognition.Enums;
using TTShang.Core.LicensePlateRecognition.Services;
using TTShang.Core.Module;
using Microsoft.Extensions.DependencyInjection;

namespace TTShang.Core.Api.Impl.LicensePlateRecognition
{
    /// <summary>
    /// 车牌识别
    /// </summary>
