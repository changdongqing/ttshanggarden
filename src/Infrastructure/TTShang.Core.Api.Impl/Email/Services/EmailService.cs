...
using TTShang.Core.Email.Enums;
...
namespace TTShang.Core.Api.Impl.Email.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        {
            return await GetEmailServerConfig(EmailServerTag.Default);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public async Task<bool> Send(SendEmailInputDto input)
        {
            ...
            {
                throw Oops.BahLocalFrom<SharedLocalResource>(ExceptionCode.Email_Server_No_Find);
            }
