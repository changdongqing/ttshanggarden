...
namespace TTShang.Core.Audit.Dtos
{
    /// <summary>
    /// 实体审计信息
    /// </summary>
    ...
    public class AuditEntityDto : TenantBaseDto<Guid>
    {
        ...
        /// 功能审计编号
        /// </summary>
        [Display(Name = nameof(AuditLocalResource.AuditFunctionId), ResourceType = typeof(AuditLocalResource))]
        public Guid AuditFunctionId { get; set; }
        /// <summary>
        /// 获取或设置 操作实体属性集合
        /// </summary>
