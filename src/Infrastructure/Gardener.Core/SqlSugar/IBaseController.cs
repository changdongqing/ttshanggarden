...
namespace Gardener.Core.SqlSugar
{
    /// <summary>
        ...
        where TDto : class, new()
    {
        ...
        /// <returns></returns>
        Task<PageList<TDto>> GetPage(int pageIndex = 1, int pageSize = 10);
        /// <summary>
        /// 新增
        /// </summary>
        ...
        /// <returns></returns>
        Task<PageList<TDto>> Search(PageRequest request);

        /// <summary>
        /// 此方法用来补充 PageList 不包含的 TotalItems
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
