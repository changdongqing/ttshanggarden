...
namespace TTShang.Core.Client.Impl.Extensions
{
    /// <summary>
    /// 装配ApiSetting
    ...
    public static class ApiSettingExtension
    {
        ...
        public static void AddApiSetting(this IServiceCollection services, IConfiguration configuration, string? hostBaseAddress = null)
        {
