...
using Gardener.Core.Api.Impl.Authorization.Internal.Options;
...
namespace Gardener.Core.Api.Impl.Authorization.Internal
{
    ...
    /// JwtBearer服务
    /// </summary>
    internal class JwtBearerService : IJwtService
    {
        ...
        public async Task<JsonWebToken> RefreshToken(string oldRefreshToken)
        {
            ...
            {
                throw Oops.BahLocalFrom<SharedLocalResource>(ExceptionCode.Refreshtoken_No_Exist_Or_Expire);
            }
        ...
        private JWTSettingsOptions GetJWTSettingsOptions(IdentityType identityType)
        {
            ...
            {
                throw Oops.BahLocalFrom<SharedLocalResource>(identityType + " JWTSettings is no find");
            }
        }
        /// <summary>
        /// 创建
        ...
        private Identity ReadToken(string tokenStr)
        {
            ...
            {
                throw Oops.BahLocalFrom<SharedLocalResource>(ExceptionCode.Token_Invalid);
            }
