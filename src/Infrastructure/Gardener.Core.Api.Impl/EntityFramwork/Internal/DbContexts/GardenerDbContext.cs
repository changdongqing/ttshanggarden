...
namespace Gardener.Core.Api.Impl.EntityFramwork.Internal.DbContexts
{
    ...
    public class GardenerDbContext : AppDbContext<GardenerDbContext, MasterDbContextLocator>
    {
        ...
        public GardenerDbContext(DbContextOptions<GardenerDbContext> options, IIdentityService identityService) : base(options)
        {
