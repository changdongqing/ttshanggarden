...
namespace Gardener.Core.Api.Impl.Cache.Internal
{
    internal class CacheImpl : ICache
    {
        ...
        {
            return Get(key, func, new DistributedCacheEntryOptions()
        ...
        {
            return await GetAsync(key, func, new DistributedCacheEntryOptions()
                    .SetAbsoluteExpiration(DateTimeOffset.MaxValue));
        }
        /// <summary>
        /// 获取缓存
