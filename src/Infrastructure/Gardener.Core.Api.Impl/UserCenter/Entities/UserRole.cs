    ...
    public class UserRole : UserRoleDto, IEntityBase<MasterDbContextLocator, GardenerMultiTenantDbContextLocator>, IEntitySeedData<UserRole, MasterDbContextLocator, GardenerMultiTenantDbContextLocator>, IEntityTypeBuilder<UserRole, MasterDbContextLocator, GardenerMultiTenantDbContextLocator>
    {
        ...
        public IEnumerable<UserRole> HasData(DbContext dbContext, Type dbContextLocator)
        {
            return new[] {
                ...
                new UserRole{ UserId = 13, RoleId = 5, CreatedTime = DateTimeOffset.FromUnixTimeSeconds(1628689311),CreateBy="1",CreateIdentityType=IdentityType.User,TenantId=Guid.Parse("5841a727-9b01-4782-ae49-c0b000e4cbe4") },
            };
        }
    }
}