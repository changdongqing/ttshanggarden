...
namespace TTShang.Core.Client.Components.PageBaseClass
{
    ...
    /// <remarks>
    /// <code>包含列表加载、删除、导出、种子数据、添加、修改、详情</code>
    /// <code>快递打开操作框，输入 OperationDialogInput_TKey</code>
    /// <code>快递打开操作框，输出 OperationDialogOutput_TKey</code>
    /// </remarks>
    ...
    /// <remarks>
    /// <code>包含列表加载、删除、导出、种子数据、添加、修改、详情</code>
    /// <code>快递打开操作框，输入<see cref="OperationDialogInput.{TKey}"/></code>
    /// <code>快递打开操作框，输出<see cref="OperationDialogOutput.{TKey}"/></code>
    /// <code>此基类方便那些不需要弹出或弹出时没有输入输出时使用</code>
    /// <code>自身作为OperationDialog接收的参数，默认为类型 <see cref="TKey"/></code>
    /// <code>自身作为OperationDialog返回的参数，默认为类型 <see cref="bool"/></code>
    /// </remarks>
    ...
    /// <remarks>
    /// <code>包含列表加载、删除、导出、种子数据、添加、修改、详情</code>
    /// <code>本地化资源，默认使用<see cref="SharedLocalResource"/></code>
    /// <code>快递打开操作框，输入<see cref="OperationDialogInput.{TKey}"/></code>
    /// <code>快递打开操作框，输出<see cref="OperationDialogOutput.{TKey}"/></code>
    /// <code>此基类方便那些不需要弹出或弹出时没有输入输出时使用</code>
    /// <code>自身作为OperationDialog接收的参数，默认为类型 <see cref="TKey"/></code>
    ...
    /// <code>自身作为OperationDialog返回的参数，默认为类型 <see cref="bool"/></code>
    /// </remarks>
    public abstract class ListOperateTableBase<TDto, TKey> : ListOperateTableBase<TDto, TKey, EmptyOperationDialog<TDto, TKey, SharedLocalResource>, SharedLocalResource>
        where TDto : class, new()
    {
    }
}
