...
namespace TTShang.Core.Client.SignalR
{
    ...
    public interface ISignalRClient
    {
        ...
        /// <returns></returns>
        ISignalRClient AutomaticReconnectDefaultRetryPolicy(TimeSpan[]? defaultRetryPolicyReconnectDelays = null);
        /// <summary>
        /// 开启自动重连
        /// </summary>
        ...
        /// <returns></returns>
        ISignalRClient AutomaticReconnectCustomRetryPolicy(long maxRetryNumber, double retryIntervalSeconds);
        /// <summary>
        /// 创建连接并开启
        /// </summary>
        Task Connection();
